...
I mentioned that the certificate generated by Cosign is only valid for 10 minutes and you may be wondering how this very likely expired certificate can be used by the users to verify artifacts? 
The verification process is different from normal certification validation for example TLS verification that probably you are more familiar with.
